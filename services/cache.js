...
mongoose.Query.prototype.cache = function(hkey){
    ...
    // this is the top level key like bibliotheque
    this.hashkey = JSON.stringify(hkey || '')

    return this;
}

// stock la fonction exec() par défaut dans la variable exec.
const exec = mongoose.Query.prototype.exec 

mongoose.Query.prototype.exec = async function(){ // Modifing the exec property of mongoose //fonction exec
